              ...
              <div class="card-footer">
                <form id="short_url">
                  <div class="input-group">
                    <input type="text" name="link" placeholder="Type Url ..." class="form-control">
                ...
                <table class="table table-bordered">
                  <thead>
                    <tr>
                      ...
                      <th>Title</th>
                      <th>Url</th>
                      <th style="width: 40px">Short Url</th>
                    </tr>
                  </thead>
                  <tbody>
...
$("#short_url").validate({
    ...
    submitHandler: function(form) {
        ...
        var formData = $(short_url).serialize();
